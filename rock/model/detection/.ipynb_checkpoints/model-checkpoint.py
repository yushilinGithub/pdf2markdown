...
from src.rock.model.detection.config import EfficientViTConfig
from src.rock.model.detection.processor import SegformerImageProcessor
from src.rock.settings import settings
import src.config_util as cfg


def load_model(checkpoint=cfg.LINE_DETECTION_MODEL_PATH, device=cfg.DEVICE, dtype=settings.MODEL_DTYPE):
    """l"""
...
def load_processor(checkpoint=cfg.LINE_DETECTION_MODEL_PATH,):
    """l"""
