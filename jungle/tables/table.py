...
from jungle.schema.bbox import merge_boxes, box_intersection_pct, rescale_bbox
from jungle.schema.block import Line, Span, Block
from jungle.schema.page import Page
from tabulate import tabulate
from typing import List

from jungle.settings import settings
from jungle.tables.cells import assign_cells_to_columns
from jungle.tables.utils import sort_table_blocks, replace_dots, replace_newlines
            ...
            for block_idx, block in enumerate(page.blocks):
                ...
                if intersect_pct > settings.BBOX_INTERSECTION_THRESH and block.block_type == "Table":
                    if table_idx not in table_insert_points:
                        ...
                        table_insert_points[table_idx] = block_idx - len(blocks_to_remove) + table_idx 
